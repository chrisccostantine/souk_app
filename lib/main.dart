...
class _SellerHubPageState extends State<SellerHubPage>
  ...
  bool _shopifyNeedsReconnect = false;
      ...
      children: [
        ...
        if (_sellerSection == SellerMenuSection.productSync) ...[
          ...
          ShopifySyncCard(
            ...
            needsReconnect: _shopifyNeedsReconnect,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            DropdownButtonFormField<String>(
              initialValue: lebanonCities.contains(city.text)
                  ? city.text
                  : 'Beirut',
              isExpanded: true,
              decoration: const InputDecoration(
...
const List<String> lebanonCities = [
  'Beirut',
  'Achrafieh',
  'Ain El Mreisseh',
  'Bachoura',
